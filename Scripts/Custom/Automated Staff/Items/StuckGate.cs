...
namespace Server.Items
{
    public class StuckGate : Moongate
    {
        ...
        [Constructable]
        public StuckGate(bool decays) : base(new Point3D(3501, 2576, 14), Map.Trammel) //this is where the gate goes to, change it if you wish.  Currently, pops open at Britain healers in Felucca.
        {
            Dispellable = false;
            ItemID = 0x1FD4;
            Name = "Stuck Gate";
